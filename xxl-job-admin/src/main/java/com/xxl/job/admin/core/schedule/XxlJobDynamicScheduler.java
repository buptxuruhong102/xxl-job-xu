...
public final class XxlJobDynamicScheduler implements ApplicationContextAware {
    ...
    public static XxlJobWaitQueueDao xxlJobWaitQueueDao;
    public static XxlJobInfoRelDao xxlJobInfoRelDao;
	...
	public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        ...
        XxlJobDynamicScheduler.xxlJobWaitQueueDao = applicationContext.getBean(XxlJobWaitQueueDao.class);
        XxlJobDynamicScheduler.xxlJobInfoRelDao = applicationContext.getBean(XxlJobInfoRelDao.class);
	}
