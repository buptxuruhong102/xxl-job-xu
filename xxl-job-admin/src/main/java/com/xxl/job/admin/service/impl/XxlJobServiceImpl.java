...
public class XxlJobServiceImpl implements XxlJobService {
	...
	public ReturnT<String> add(XxlJobInfo jobInfo) {
		...
		//add parent
		addParent(jobInfo.getChildJobId(), jobInfo.getId());
	...
	private void addParent(String parentIds, int jobId){
		//add parent
		xxlJobInfoRelDao.deleteByJobId(jobId);
		String[] parentJobIds = StringUtils.split(parentIds, ",");
		for(String parentJobId: parentJobIds){
			XxlJobInfoRel rel = new XxlJobInfoRel();
			rel.setJobId(jobId);
			rel.setParentJobId(Integer.parseInt(parentJobId));
			xxlJobInfoRelDao.save(rel);
		}
	}
	...
	@Override
	public ReturnT<String> triggerJob(int id, TriggerType type) {

		JobTriggerPoolHelper.trigger(id, type);
		return ReturnT.SUCCESS;
