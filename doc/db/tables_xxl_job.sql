...
CREATE TABLE `XXL_JOB_QRTZ_TRIGGER_INFO_REL` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `job_id` int(11) NOT NULL COMMENT '任务ID',
  `parent_job_id` int(11) NOT NULL COMMENT '父任务ID',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

CREATE TABLE `XXL_JOB_QRTZ_WAIT_TRIGGERS_QUEUE` (
  `job_id` int(11) NOT NULL COMMENT '任务ID',
`create_time` datetime NOT NULL COMMENT '入队时间',
  PRIMARY KEY (`job_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
